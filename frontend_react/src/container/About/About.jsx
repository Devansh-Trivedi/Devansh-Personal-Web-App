    ...
    <div className="About">
      ...
      <div className="card">
        ...
        <div className="infos">
          ...
          <p className="text" >
            I'm BTech Computer Science graduate with keen interest in Machine
            Learning and Product Development. I believe in leveraging technology
            by solving real world problems. I noticed that my work held the
            potential to spread positivity and impact other peoples’ lives in a
